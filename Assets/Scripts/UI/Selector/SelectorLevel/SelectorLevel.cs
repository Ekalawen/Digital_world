...
public class SelectorLevel : MonoBehaviour {
    ...
    public void ResetScores() {
        List<string> keysSuffix = new List<string>() {
            PrefsManager.NB_WINS,
            PrefsManager.NB_DEATHS,
            PrefsManager.TOTAL_CREDITS_SCORE,
            PrefsManager.BEST_CREDITS_SCORE,
            PrefsManager.TOTAL_BLOCKS_SCORE,
            PrefsManager.BEST_BLOCKS_SCORE,
            PrefsManager.PRECEDENT_BEST_BLOCKS_SCORE,
            PrefsManager.SINCE_LAST_BEST_BLOCKS_SCORE,
            PrefsManager.HAS_JUST_WIN,
            PrefsManager.HAS_JUST_MAKE_BEST_BLOCKS_SCORE,
            PrefsManager.HAS_ALREADY_DISCOVER_LEVEL,
            PrefsManager.IS_LEVEL_HIGHLIGHTED,
            PrefsManager.DATA_COUNT,
            PrefsManager.PRECEDENT_DATA_COUNT,
            PrefsManager.HAS_JUST_INCREASED_DATA_COUNT,
        };
