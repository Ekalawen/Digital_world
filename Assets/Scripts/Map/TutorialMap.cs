...
public class TutorialMap : MapManager {
    ...
    void generateTutorialMap() {
		...
		nbLumieres++;
		Instantiate (lumierePrefab, new Vector3(20, 1, 5), Quaternion.identity);
		...
		nbLumieres++;
		Instantiate (lumierePrefab, new Vector3(50, -9, 3), Quaternion.identity);
		...
		nbLumieres++;
		Instantiate (lumierePrefab, new Vector3(66, -6, 3), Quaternion.identity);
		...
		foreach(Collider c in Physics.OverlapBox(new Vector3(76f, -3f, 4f), new Vector3(0.3f, 2f, 0.3f))) // colonne
			Destroy(c.gameObject);
		nbLumieres++;
		Instantiate (lumierePrefab, new Vector3(77, -3, 3), Quaternion.identity);
		...
		nbLumieres++;
		Instantiate (lumierePrefab, new Vector3(105.5f, 3f, 4f), Quaternion.identity); // Un objectif à attraper en plein vol ! <3
		...
		nbLumieres++;
		Instantiate (lumierePrefab, new Vector3(134, 1, 3), Quaternion.identity);
		...
		nbLumieres++;
		Instantiate (lumierePrefab, new Vector3(137, 1, 22), Quaternion.identity);
		...
		nbLumieres++;
		Instantiate (lumierePrefab, new Vector3(160, -4, 20), Quaternion.identity);
		nbLumieres++;
		Instantiate (lumierePrefab, new Vector3(160, -4, 22), Quaternion.identity);
		nbLumieres++;
		Instantiate (lumierePrefab, new Vector3(160, -4, 24), Quaternion.identity);
		nbLumieres++;
		Instantiate (lumierePrefab, new Vector3(170, -4, 22), Quaternion.identity);
		...
		nbLumieres++;
		Instantiate (lumierePrefab, new Vector3(202, 6, 12), Quaternion.identity);
	}
}
